  ...
  const steps = [
    {
      ...
      description: 'Comprehensive skin analysis and personalized treatment planning',
      icon: '💬',
      duration: '30 mins'
    },
    {
    ...
    <section id="process" className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto section-padding relative z-10">
        <div className="text-center mb-16">
          <span className="text-primary-600 font-medium tracking-wider uppercase">The Journey</span>
          <h2 className="font-display text-4xl md:text-5xl font-bold mt-4">
            Your Treatment
            <span className="block gradient-text">Process</span>
          </h2>
          <p className="text-lg text-neutral-600 mt-4 max-w-2xl mx-auto">
            A clear, structured approach to achieving your skin transformation goals
          </p>
        </div>
            ...
            <div className="space-y-8">
              {steps.map((step, index) => (
                <div key={index} className="relative flex items-start gap-6">
                  {/* Step number circle */}
                  <div className="relative z-10 flex-shrink-0 w-16 h-16 bg-gradient-to-br from-primary-400 to-primary-600 rounded-full flex items-center justify-center text-white font-bold text-lg shadow-lg">
                    {step.number}
                  </div>
                  
                  {/* Content card */}
                  <div className="flex-1 bg-white rounded-2xl p-5 shadow-premium hover:shadow-premium-lg transition-all duration-300">
                    <div className="flex items-start justify-between mb-3">
                      <h3 className="font-bold text-lg">{step.title}</h3>
                      <span className="text-3xl ml-3">{step.icon}</span>
                    </div>
        ...
        <div className="mt-16 bg-gradient-to-br from-primary-50 to-white rounded-3xl p-8 lg:p-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-neutral-700">Day 1-2: Redness and swelling, similar to sunburn</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary-500 mr-3 mt-1">✓</span>
                  <span className="text-neutral-700">Day 3-5: Skin begins to peel and regenerate</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary-500 mr-3 mt-1">✓</span>
                  <span className="text-neutral-700">Day 5-7: New skin emerges, makeup can be applied</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary-500 mr-3 mt-1">✓</span>
                  <span className="text-neutral-700">Week 2+: Continued improvement and collagen production</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-premium">
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-neutral-600">We're here throughout your journey</p>
                </div>
              </div>
              ...
              <button onClick={onBookingClick} className="text-primary-600 font-medium hover:text-primary-700">
